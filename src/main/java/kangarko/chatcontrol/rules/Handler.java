...
public class Handler {
	...
	/** The name of the handler. It's automatically set from the handler name in handlers file. */
	...
	/** A message displayed to the player that triggered the handler. Set to 'none' to disable. */
	private String playerWarnMsg;
	
	/** A message broadcasted to everyone. Set to 'none' to disable. */
	private String broadcastMsg;
	
	/** People with specified permission will recieve {@link #staffAlertMsg}. Functional only when
	 * {@link #staffAlertMsg} is 'none'. */
	private String staffAlertPermission;
	
	/** A message broadcasted to staff with {@link #staffAlertPermission}. Set to 'none' to disable. */
	...
	/** A name of a file that message will be writed in. Variables: %time %player %message Set to
	 * 'none' to disable writing. */
	private String writeToFileName;
	
	/** Should the message be blocked from appearing? This cancels for instance player chat event or
	 * command event. */
