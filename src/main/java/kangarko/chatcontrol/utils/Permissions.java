 ...
 * 
 * If you are not familiar with Java and want to use these permissions, just add a player permission
 * from the brackets which looks like:
 * 
...
public class Permissions {
	...
	public class Commands {
		...
		// Chat clear without broadcasting player who cleared the chat with "/chc clear -anonymous"
		// command.
	...
	public class Bypasses {
		...
		// Allow player to chat even when they did not moved since joining the server. Not recommended
		// due to spam bots.
		...
		// Allow player to tab complete. (Notice: If you are using Spigot it is highly recommended to
		// disable this feature and use the inbuilt one in spigot.yml)
		...
		public static final String PUNCTUATE = "chatcontrol.bypass.punctuate"; // TODO NB: Permission
																																						// changed in v5.0.0
																																						// from insertdot to
																																						// punctuate.
	...
	public class Formatter {
		// TODO NB: Permissions related to formatting/coloring chat changed in v5.0.0. Now with
		// ".format." in between.
	...
	// TODO New in 5.0.0 Permission to view timed message from broadcaster. (true by default, needs to
